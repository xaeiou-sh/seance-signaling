...
export class SeanceChart extends Chart {
  constructor(scope: Construct, id: string, props: ChartProps = {}) {
    ...
    // Reference to externally-managed Secret (created by deployment script via kubectl)
    // This secret is NOT generated by cdk8s - it's created separately from SOPS-encrypted secrets
    // See scripts/apply-secrets.sh for how this secret is created
    const appSecrets = kplus.Secret.fromSecretName(this, 'app-secrets', 'seance-secrets');
